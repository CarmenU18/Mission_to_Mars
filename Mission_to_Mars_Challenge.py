...
# Instead of scraping each row, or the data in each <td />, we're going to scrape the entire table with Pandas' 
# .read_html() function, para esto es necesario añadir a nuestra dependencias import pandas as pd.
df = pd.read_html('https://galaxyfacts-mars.com')[0]
df.columns=['description', 'Mars', 'Earth']
df.set_index('description', inplace=True)

# Cconvertir fácilmente nuestro DataFrame en código listo para HTML
df.to_html()
